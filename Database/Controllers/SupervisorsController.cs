...
namespace GraduationDatabase.Controllers
{
    public class SupervisorsController : Controller
    {
        ...
        public SupervisorsController(WebDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Supervisor supervisor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Supervisor supervisor)
        {
            if (id != supervisor.Id)
            {
                return NotFound();
